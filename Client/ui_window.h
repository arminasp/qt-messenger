...
"color: white;"));
        ...
        status_text_label->setObjectName(QStringLiteral("status_text_label"));
        status_text_label->setGeometry(QRect(350, 0, 141, 81));
        status_text_label->setStyleSheet(QLatin1String("color: white;\n"
...
""));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 150, 216));
...
"font: 8pt;"));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 403, 159));
...
"color: white;"));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 403, 159));
...
"color: white;"));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 403, 159));
...
"}"));
    ...
    void retranslateUi(QMainWindow *WindowClass)
    {
        ...
        status_text_label->setText(QApplication::translate("WindowClass", "Connection lost...", 0));
